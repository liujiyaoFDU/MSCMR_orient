...
valid_iter=DataLoader(dataset, batch_size=32, shuffle=False,
                            num_workers=num_workers)
...
for epoch in range(num_epochs):
    ...
    if valid_acc>best_acc:
        torch.save(net.state_dict(), "./checkpoints/new/model-best.pth")
        best_acc = valid_acc
    torch.save(net.state_dict(), "./checkpoints/new/model-latest.pth")
